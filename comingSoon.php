...
<body>
  ...
  <h1 class="h1 fw-bold mb-0 " style="color:#bd1e1e; text-align: center;" >COMING SOON COMING SOON COMING SOON COMING SOON </h1>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active" data-bs-interval="10000">
        <img src="./DBImages/product_images/sheet_mask_2.jpeg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
        </div>
      </div>
      <div class="carousel-item" data-bs-interval="2000">
        <img src="./DBImages/product_images/Coming_soon.jpeg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
        </div>
      </div>
      <div class="carousel-item">
        <img src="./DBImages/product_images/Coming_soon_2.jpeg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
        </div>
      </div>
    </div>
